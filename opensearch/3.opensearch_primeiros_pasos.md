...
É posible:
- Ordenar documentos
- Seleccionar que campos se mostran
...
1. No panel lateral esquerdo, localizar un campo (por exemplo `nivel`)
2. Premer sobre o valor desexado (por exemplo `warn`)
3. Seleccionar:
...
Tamén é posible crear filtros manualmente desde a barra superior, combinando varias condicións.
